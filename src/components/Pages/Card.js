  ...
  return (
    <div className="card-ctrl shadow p-3 mb-4">
      ...
      <div className="row row-ctrl " >
        <div className=" col-lg-12 col-md-12 col-sm-12  left-ctrl1">
          ...
          <div className="right-ellip-ctrl" >

            {
              props.post.author._id == user.user._id ?

                <div className=" float-end ver-elip-ctrl dan-ctrl " >
      ...
      <div className="row">
        ...
        <div className="col-lg-12 col-md-12 col-sm-12 mt-3 card-bottom-ctrl">
